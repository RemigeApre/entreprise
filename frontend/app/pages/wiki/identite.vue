    ...
    <div class="flex-1 overflow-y-auto">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div class="flex items-center gap-3 mb-8">
          <div class="size-12 rounded-lg bg-amber-100 flex items-center justify-center">
            <UIcon name="i-lucide-palette" class="size-6 text-amber-700" />
          </div>
          <div>
            <h1 class="font-heading text-2xl font-bold text-stone-900">Notre identite</h1>
            <p class="text-sm text-stone-500">Charte graphique & mood board</p>
          </div>
        </div>
        ...
        <UCard class="mb-6">
          <div class="text-center py-4">
            <p class="font-heading text-xl italic text-stone-700">Obscuritas nutrit flammam.</p>
            <p class="text-sm text-stone-500 mt-1">L'obscurite nourrit la flamme.</p>
          </div>
        </UCard>
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Naissance</h3>
          </template>
          <div class="prose prose-stone prose-sm max-w-none space-y-3">
            ...
            <p class="italic text-stone-500">Nous etions chenilles, nous sommes en chrysalide. Bientot, nous seront ces papillons de nuit, attires par la bougie.</p>
          </div>
        </UCard>
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Objectifs</h3>
          </template>
          <div class="prose prose-stone prose-sm max-w-none space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <UCard>
            <template #header>
              <h3 class="text-sm font-semibold text-stone-900">References artistiques</h3>
            </template>
            <div class="prose prose-stone prose-sm max-w-none space-y-3">
          ...
          <UCard>
            <template #header>
              <h3 class="text-sm font-semibold text-stone-900">Ambiances</h3>
            </template>
            <div class="prose prose-stone prose-sm max-w-none space-y-3">
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Ton et voix</h3>
          </template>
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Logo et armoiries</h3>
          </template>
          <div class="flex flex-col sm:flex-row items-center gap-6">
            <div class="shrink-0 p-6 bg-[rgba(175,143,60,0.04)],143,60,0.03)] rounded-lg">
              <img src="/logo.svg" alt="Armoiries Le Geai" class="w-32 h-32" />
            </div>
            <div class="prose prose-stone prose-sm max-w-none space-y-2">
              ...
              <p class="text-stone-500 text-xs">Deux variantes : couleur et noir & blanc. Une troisieme en or/argent pour les editions rares.</p>
            </div>
          </div>
        </UCard>
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Palette de couleurs</h3>
          </template>
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div class="text-center">
              <div class="h-20 rounded-lg mb-2" style="background-color: #af8f3c" />
              <p class="text-xs font-semibold text-stone-900">Sable des reves perdus</p>
              <p class="text-xs text-stone-500">#af8f3c</p>
            </div>
            <div class="text-center">
              <div class="h-20 rounded-lg mb-2" style="background-color: #b74d34" />
              <p class="text-xs font-semibold text-stone-900">Rouge antique</p>
              <p class="text-xs text-stone-500">#b74d34</p>
            </div>
            <div class="text-center">
              <div class="h-20 rounded-lg mb-2" style="background-color: #1f2c23" />
              <p class="text-xs font-semibold text-stone-900">Vert de minuit</p>
              <p class="text-xs text-stone-500">#1f2c23</p>
            </div>
            <div class="text-center">
              <div class="h-20 rounded-lg mb-2 border border-[rgba(175,143,60,0.1)]" style="background-color: #f7f0de" />
              <p class="text-xs font-semibold text-stone-900">Lune de lait</p>
              <p class="text-xs text-stone-500">#f7f0de</p>
            </div>
          </div>
        </UCard>
        ...
        <UCard class="mb-6">
          <template #header>
            <h3 class="text-sm font-semibold text-stone-900">Typographie</h3>
          </template>
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 text-sm">
            <div>
              <p class="font-semibold text-stone-900 mb-1">Titres et sous-titres</p>
              <p class="text-stone-500">IM Fell DW Pica</p>
            </div>
            <div>
              <p class="font-semibold text-stone-900 mb-1">Textes</p>
              <p class="text-stone-500">Crimson Pro</p>
            </div>
            <div>
              <p class="font-semibold text-stone-900 mb-1">Accents</p>
              <p class="text-stone-500">UnifrakturCook</p>
            </div>
          </div>
        </UCard>

        <!-- Footer -->
        <div class="text-center text-xs text-stone-400 pb-8">
