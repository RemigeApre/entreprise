...
<template>
  <div class="transparence" :class="{ 'is-visible': visible }">
    <div class="transparence-container">

      <!-- Header -->
      <header class="tr-header">
        <span class="tr-numeral">IV</span>
        <h1 class="tr-title">Transparence</h1>
        <div class="tr-rule" />
      </header>
...
.is-visible .transparence-container {
  opacity: 1;
